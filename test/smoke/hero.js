...
describe('My Little Hero', function () {
    ...
    describe('Labels are correct', function () {
       ...
       it.skip('TC-009 Label for age name = 3. How old is your Hero?', function () {
        ...
        // });
        // it('##### Verify that type of story contains =  Journey and Return', function () {
        //     expect($$(sel.dropdownStory)[3].getText()).toEqual(exp.story4);
        // });
        // it('##### Verify that type of story contains =   Rags and Riches', function () {
        //     expect($$(sel.dropdownStory)[4].getText()).toEqual(exp.story5);
        // });
        // it('##### Verify that type of story contains =  Tragedy', function () {
